...
function Game(p1, p2, p3, p4) {
	...
	this.winPoint = function(player){
		...
		else
		{
			...
			if(player == this.player3 && ((this.player1.score >= 4 && this.player1.score-player2.score >= 2) || (this.player2.score >= 4 && this.player2.score - this.player1.score >= 2)))
				{
				this.player1.score = 0;
				this.player2.score = 0;
				this.player1.addGame();
				}
			else if(player == this.player4 && ((this.player1.score >= 4 && this.player1.score-player2.score >= 2) || (this.player2.score >= 4 && this.player2.score - this.player1.score >= 2))) 
				{
				this.player1.score = 0;
				this.player2.score = 0;
			...
			else if((this.player1.score >= 4 && this.player1.score-player2.score >= 2) || (this.player2.score >= 4 && this.player2.score - this.player1.score >= 2)) 
				{
				this.player1.score = 0;
				this.player2.score = 0;
				player.addGame();
